...
5. For harness content: [`assets-blueprint`](https://github.com/krerapus/assets-blueprint) packs
...
- Skill: `skill-creator` from the `core` pack. See [skill-naming](https://github.com/krerapus/assets-blueprint/blob/master/docs/standards/skill-naming.md) and [skills inventory](https://github.com/krerapus/assets-blueprint/blob/master/docs/skills.md).
...
- Diverge pack content only in [`assets-blueprint`](https://github.com/krerapus/assets-blueprint)
